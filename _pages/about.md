...
[[J29] F. Zhang, C.L. Jin*, W.G. Xia, X.M. Sun, H. Bai. Cooperative pointing control of coplanar multi-robot systems via distributed target estimation. Automatica, <em>submitted</em>, 2024](https://newandyc.github.io/)

[[J28] H.X. Hu, G.H. Wen*, Y. Chen, F. Zhang, T.W. Huang. Social power evolution analysis for Friedkin-Johnsen model with oblivious individuals. IEEE Transactions on Cybernetics, <em>submitted</em>, 2023](https://newandyc.github.io/)

[[J27] S.Y. Meng, F.W. Meng*, F. Zhang, Q. Li, Y. Zhang, A. Zemouche. Observer design method for nonlinear generalized systems with nonlinear algebraic constraints with applications. Automatica <em>regular paper</em>, <em>online</em>, 2023](https://www.sciencedirect.com/science/article/pii/S0005109824000049?ref=pdf_download&fr=RR-3&rr=887bd74b8fb32a9e)

[[J26] P. Ramazi*, F. Zhang, M. Cao. Cooperative concurrent targeting for planar arrays of point sources. Automatica, online, 2023](https://www.sciencedirect.com/science/article/pii/S000510982300523X)

[[J25] F. Zhang, Y.L. Li*, W.G. Xia, T. Liu, W.W. Yu. Synchronization of Lur’e networks via heterogeneous unknown interconnections. IEEE Transactions on Circuits and Systems II: Express Briefs, 71(2):807-811, February 2024](https://ieeexplore.ieee.org/document/10247617)

[[J24] J.Z. Wu, S. Yuan, Q.Q. Dang, F. Zhang*, W.W. Yu. Cooperative pointing control of collinear double-integrators without angular velocity. Journal of the Franklin Institute, 360(12):9050-9064, August 2023](https://www.sciencedirect.com/science/article/pii/S0016003222005786)

[[J23] T.T. Zhang, S.J. Zhang*, F.Z. Guo, X.T. Zhao, F. Zhang. Prescribed time attitude containment control for satellite cluster with bounded disturbances. ISA Transactions, 137:160-174, June 2023](https://www.sciencedirect.com/science/article/pii/S0019057822006498)

[[J22] X.L. Wang, H.S. Su*, F. Zhang, G.R. Chen. A robust distributed interval observer for LTI systems. IEEE Transactions on Automatic Control <em>full paper</em>, 68(3):1337-1352, March 2023<](https://ieeexplore.ieee.org/document/9713996)

[[J21] N. Wang, G.H. Wen*, Y. Wang, F. Zhang, A. Zemouche. Fuzzy adaptive cooperative consensus tracking of high-order nonlinear multi-agent networks with guaranteed performances. IEEE Transactions on Cybernetics, 52(9):8838-8850, September 2022](https://ieeexplore.ieee.org/document/9364908)

[[J20] N. Wang, Y. Wang, G.H. Wen*, M.L. Lv, F. Zhang. Fuzzy adaptive constrained consensus tracking of high-order multi-agent networks: A new event-triggered mechanism. IEEE Transactions on Systems, Man and Cybernetics: Systems, 52(9):5468-5480, September 2022](https://ieeexplore.ieee.org/document/9629323)
